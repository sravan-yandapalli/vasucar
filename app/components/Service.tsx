...
const services = [
  {
    ...
    desc: "Point-to-point drop anywhere inside Ongole city with clean AC cars.",
    img: "/s1.jpeg",
  },
  {
    title: "Airport Transfers",
    desc: "24/7 airport pickup & drop from Ongole to Hyderabad/Vijayawada and other airports.",
    img: "/s2.jpeg",
  },
  {
  ...
  },
  {
    ...
    desc: "Affordable one-way cabs from Ongole to Tirupati, Hyderabad, Vijayawada, Chennai, Bangalore.",
    img: "/s4.jpeg",
  },
  {
    title: "Outstation Round Trip",
    desc: "Round-trip packages for temple, family trips and business travel from Ongole.",
    img: "/s5.jpeg",
  },
  {
    title: "Weddings & Functions",
    desc: "Multiple car coordination for marriages and family functions in and around Ongole.",
    img: "/s6.jpeg",
  },
];
      ...
      <div className="mx-auto max-w-[1440px] w-full px-4 py-10 lg:py-14">
        ...
        <div className="mt-6 md:hidden">
          <div className="flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory no-scrollbar scroll-smooth">
            {services.map((s) => (
              ...
              >
                {/* image block with fixed aspect ratio & cover */}
        ...
        <div className="mt-8 hidden md:grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {services.map((s) => (
            <article
              key={s.title}
              className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow hover:shadow-lg transition-shadow"
            >
              <div className="w-full aspect-[4/3] bg-neutral-100">
                <img
                  src={s.img}
